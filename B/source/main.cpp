...
int main(void)
{
    ...
    ASSERT_NO_FAILURE_INT(ble.init());
    ASSERT_NO_FAILURE_INT(ble.gap().setScanParams(500 /* scan interval */, 200 /* scan window */, 0, true /* active scanning */));
    ASSERT_NO_FAILURE_INT(ble.gap().startScan(advertisementCallback));
